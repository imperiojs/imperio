...
imperio.mobileLocationShare = require('./Mobile/mobileGeoLocationShare.js');
...
imperio.desktopLocationHandler = require('./Desktop/desktopGeoLocationHandler.js');
...
const events = ['pan', 'panStart', 'panEnd', 'pinch', 'press', 'swipe', 'tap', 'pinchStart', 'pinchEnd'];
